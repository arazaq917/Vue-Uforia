<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{ invalid: !description.isValid }">
      <label for="description" id="fname">Description</label>
      <textarea
        id="description"
        rows="5"
    ...
    <div class="form-control" :class="{ invalid: !rate.isValid }">
      <label for="rate" id="rate">Hourly Rate</label>
      <input
        type="number"
        id="rate"
      ...
      />
      <p v-if="!rate.isValid">Rate must e greater than 0.</p>
    </div>
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      ...
      <p v-if="!areas.isValid">Atleast one area must be checked.</p>
    </div>
    <p v-if="!formIsValid">Please enter correct data</p>
